  ...
  return (
    <>
      <header
        ...
        style={{
          backgroundColor: scrolled ? "var(--header-bg-scrolled)" : "var(--header-bg-idle)",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              LEAD<span style={{ color: "var(--text-primary)" }}>ForEarth</span>
            </span>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-1" aria-label="Primary">
            <Link
              ...
              style={{
                color: isHome ? "var(--brand)" : "var(--text-body)",
                backgroundColor: isHome ? "var(--overlay-brand-hover)" : "transparent",
              }}
              onMouseEnter={(e) => {
                if (!isHome) e.currentTarget.style.backgroundColor = "var(--overlay-hover)";
              }}
              onMouseLeave={(e) => {
            ...
            <Link
              ...
              className="px-4 py-2 rounded-full text-[13.5px] font-medium transition-colors duration-200"
              style={{
                color: onGuidelines ? "var(--brand)" : "var(--text-body)",
                backgroundColor: onGuidelines ? "var(--overlay-brand-hover)" : "transparent",
              }}
              onMouseEnter={(e) => {
                if (!onGuidelines) e.currentTarget.style.backgroundColor = "var(--overlay-hover)";
              }}
              onMouseLeave={(e) => {
            ...
            <Link
              ...
              className="px-4 py-2 rounded-full text-[13.5px] font-medium transition-colors duration-200"
              style={{
                color: onCommunity ? "var(--brand)" : "var(--text-body)",
                backgroundColor: onCommunity ? "var(--overlay-brand-hover)" : "transparent",
              }}
              onMouseEnter={(e) => {
                if (!onCommunity) e.currentTarget.style.backgroundColor = "var(--overlay-hover)";
              }}
              onMouseLeave={(e) => {
            ...
            <Link
              ...
              className="ml-2 inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-[13.5px] font-semibold transition-all duration-200 hover:-translate-y-px"
              style={{
                color: "var(--text-inverse)",
                backgroundColor: onReport ? "var(--brand-strong)" : "var(--brand)",
                boxShadow: onReport
                  ? "var(--shadow-brand), inset 0 0 0 1.5px rgba(255,255,255,0.15)"
                  : "var(--shadow-brand)",
              }}
            >
              Submit Report
      ...
      <div
        ...
        style={{ backgroundColor: "var(--overlay-scrim)", backdropFilter: "blur(4px)" }}
      ...
      <div
        id="mobile-menu"
        className={`md:hidden fixed top-0 right-0 bottom-0 z-50 w-[85%] max-w-sm transition-transform duration-300 ease-out ${
      ...
      >
        <div className="flex items-center justify-between px-6 pt-5 pb-4" style={{ borderBottom: "1px solid var(--border-subtle)" }}>
          <span className="text-[15px] font-semibold tracking-tight" style={{ color: "var(--brand)" }}>
            Menu
          </span>
          <button
            onClick={() => setMenuOpen(false)}
        ...
        <nav className="px-4 py-4" aria-label="Mobile">
          ...
          <div className="px-3 pt-4">
            <Link
              ...
              aria-current={onReport ? "page" : undefined}
              onClick={() => setMenuOpen(false)}
              className="flex items-center justify-center gap-2 w-full py-3 rounded-full text-[15px] font-semibold transition-all"
              style={{
                color: "var(--text-inverse)",
                backgroundColor: onReport ? "var(--brand-strong)" : "var(--brand)",
